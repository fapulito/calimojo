...
(function($, window, document, undefined) {
    ...
    $.widget('poker.table', {
        ...
        _create: function() {
            ...
            var ci = $("<input />").addClass("chat-input").attr({
                type: 'text',
                maxlength: 30
            });
            ...
            el.addClass("ui-widget ui-front stacked table " + o.game_class).attr({
                'chair-count': o.chair_count,
                'game-choice': o.game_class
            }).append(
                ...
                $("<div/>").addClass("header-icon header-icon-close").click(function() {
                    o.pokerMain.main("unwatch_table", {
                        table_id: o.table_id
                    });
                }),
                $("<div />").addClass("board"),
                ...
                $("<div />").addClass("slider-box").append(
                    ...
                    $("<input />").addClass("bet-amount").attr({
                        type: 'text'
                    })
                ),
                $("<div />").addClass("action-box").append(
                    $("<div />").addClass("action").attr({
                        no: 0
                    }),
                    $("<div />").addClass("action").attr({
                        no: 1
...
*/
        ...
        notify_join_table: function(v) {
            ...
            seat.append(
                ...
                $("<div />").addClass('avitar-graphic').css("background-image", "url(" + v.profile_pic + ")"),
        ...
        notify_message: function(opts) {
            ...
            o.chatBox.animate({
                scrollTop: o.chatBox[0].scrollHeight
            });
        },
